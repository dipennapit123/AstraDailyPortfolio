...
export const metadata: Metadata = {
  ...
  description: `Pick your zodiac sign to read today's free daily horoscope on ${site.name}. Switch between yesterday and today, with Love, Career, and Health. Entertainment only.`,
  alternates: {
    canonical: "/",
  },
  openGraph: {
    ...
    url: site.metadataBaseUrl.replace(/\/+$/, ""),
    type: "website",
  },
};
    ...
    <main className="relative z-10 mx-auto max-w-6xl px-4 pb-16 pt-24 sm:px-6 sm:pb-24 sm:pt-28 md:pt-32 text-on-surface">
      <header className="mb-8 text-center sm:mb-12">
        ...
        <p className="mx-auto mt-3 max-w-2xl px-1 text-sm leading-relaxed text-on-surface-variant sm:mt-4 sm:text-base">
          Tap a sign to read today&apos;s forecast — flip between yesterday and
          today, with Love, Career, and Health in one calm view.
        </p>
      </header>
